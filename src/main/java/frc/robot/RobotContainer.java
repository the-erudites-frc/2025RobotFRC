...
import frc.robot.commands.AlgaeInOut;
...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    //algae controls
    new JoystickButton(operatorController, XboxController.Axis.kLeftTrigger.value).onTrue(new AlgaeInOut(Robot.algae, true)); //in
    new JoystickButton(operatorController, XboxController.Axis.kRightTrigger.value).onTrue(new AlgaeInOut(Robot.algae, false)); //out
